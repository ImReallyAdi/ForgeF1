...
export default new NativeFunction({
  name: "$newProject",
  version: "1.0.0",
  description: "Returns a value from the GitHub project event payload",
  brackets: true,
  args: [
    {
      name: "property",
      ...
      type: ArgType.String,
      required: false,
      description: "The property to retrieve from the project event payload",
    },
  ],
  unwrap: true,
  ...
  async execute(ctx, [prop]) {
    ...
    if (ext.latestEventType !== "project") return this.success("");
    if (!prop)
