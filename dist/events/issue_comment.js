...
exports.default = new GithubEventHandlers_1.GithubEventHandler({
    name: "issue_comment",
    version: "1.0.0",
    description: "Triggered when a comment is created on an issue or pull request.",
    listener(payload) {
        const commands = this.getExtension(__1.ForgeGithub, true).commands.get("issue_comment");
