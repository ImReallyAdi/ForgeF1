...
exports.default = new forgescript_1.NativeFunction({
    name: "$newDelete",
    version: "1.0.0",
    description: "Returns a value from the GitHub delete (branch/tag) event payload",
    brackets: true,
    args: [
        {
            name: "property",
            ...
            required: false,
            description: "The property to retrieve from the delete event payload",
        },
    ],
    unwrap: true,
...
//# sourceMappingURL=newDelete.js.map